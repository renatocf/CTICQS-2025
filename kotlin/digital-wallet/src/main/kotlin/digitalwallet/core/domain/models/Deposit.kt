...
class Deposit(
    ...
    originatorSubwalletType: digitalwallet.core.domain.enums.SubwalletType,
    ...
    override suspend fun process(
        ...
        this.updateStatus(transactionsRepo, newStatus = digitalwallet.core.domain.enums.TransactionStatus.COMPLETED, at = postedAt)
    }
